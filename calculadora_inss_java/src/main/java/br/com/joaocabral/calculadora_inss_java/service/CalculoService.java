...
public class CalculoService {
    ...
    public Faixa selecionarFaixa(Double salario) {
        Faixa faixaSelecionada = null;
        
        for (Faixa faixa : FAIXASANTIGAS) {
    ...
    public Resultado calcularINSS(Double salario) {
        ...
        Faixa faixa = selecionarFaixa(salario);
    ...
    public Double preparaSalarioCalculo(String salario) {
        String salarioPreparado = salario.replace(",", ".");
