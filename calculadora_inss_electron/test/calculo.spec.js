...
describe('Ferramentas INSS', () => {
    ...
    describe('Cálculo Novo INSS', () => {
        ...
        it('Deve calcular o INSS', () => {
            const valorReal1 = calculo.calculaNovoINSS('1000');
            const valorEsperado1 = {
                aliquota: 7.5,
                faixa: 1,
                salario: '1000',
            ...
            const valorReal2 = calculo.calculaNovoINSS('2000');
            const valorEsperado2 = {
                aliquota: 8.220705,
                faixa: 2,
                salario: '2000',
            ...
            const valorReal3 = calculo.calculaNovoINSS('6200');
            const valorEsperado3 = {
                aliquota: 11.68953099953123,
                faixa: 4,
                salario: '6200',
                valor: 713.1853000000001
            };
            assert.equal(valorReal3.valor, valorEsperado3.valor);
        });
